...
ActiveRecord::Schema.define(version: 20180326075126) do
  ...
  add_foreign_key "diet_client_plan", "dietitians", column: "dietitianid", primary_key: "dietitianid", name: "diet-client-diet-foreign"
  add_foreign_key "diet_client_plan", "users", column: "userid", name: "diet-client-user-foreign"
  add_foreign_key "dietitian_client", "dietitians", column: "dietitianid", primary_key: "dietitianid", name: "dietitian_client_ibfk_1"
  add_foreign_key "dietitian_client", "users", column: "userid", name: "userForeign"
  add_foreign_key "dietitian_practice", "dietitians", column: "dietitianid", primary_key: "dietitianid", name: "dietitianForeign"
  add_foreign_key "dietitian_practice", "practices", column: "practiceid", primary_key: "practiceid", name: "practiceForeign"
